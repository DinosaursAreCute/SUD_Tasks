...
public class TestShapes {
    ...
    public static void main(String[] args) {
        // Rechteck-Prisma
        Shapes.Rectangle baseRect = new Rectangle(75.7, 4.0);
        Shapes.Prism prismRect = new Prism(baseRect, 6.0);
        logInfo("Basisrechteck: " + baseRect);
    ...
    private static void check(String name, double actual, double expected) {
        if (Math.abs(actual - expected) < EPSILON) {
            ...
            count_errors++;
            logError(name + " FEHLER: erwartet " + expected + ", erhalten " + actual);
        }
        System.out.println("Erfolgreiche Tests: " + count_success + ", Fehlerhafte Tests: " + count_errors);
    }
}
